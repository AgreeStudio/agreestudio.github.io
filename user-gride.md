...
#### 辅助操作
  ...
  - 左侧工具箱点击技术组件右下角图标，可以查看技术组件源码
  - 画面中选择节点按[F1]键，也可以查看技术组件源码
  
  ![lfc文件辅助操作](/images/user-guide/lfc文件辅助操作.gif)
  ![查看技术组件源码](/images/user-guide/查看技术组件源码.gif)
...
### 4.6 csd字段提取至前端工程
  - 说明: 将csd文件生成对应需要的格式提取至前端工程中
  ![服务发布](/images/user-guide/csd提取.gif)
### 4.7 图码双型
...
### 4.8 服务导出
支持将本地工程、已发布服务导出到excel文件

  - 顶部菜单栏选择 [导出服务] - [导出已发布服务]或[导出本地服务]
  - 选择文件保存位置即可

  ![本地服务导出](/images/user-guide/本地服务导出.gif)
  ![已发布服务导出](/images/user-guide/已发布服务导出.gif)
...
## 7. 首选项
  ...
  用户可通过首选项设置Agree Studio的各项配置，如文本编辑器风格、热键等
  
  ![首选项](/images/user-guide/首选项.gif)
  

## 8. 搜索
### 8.1 内容搜索 / 替换
  - 左侧选择 [搜索] 进入搜索视图，在'内容'栏输入搜索的文件内容进行搜索，支持区分大小写、全字匹配
  - 搜索结束后点击任意一行结果即可快速定位内容
  - 搜索完成后，在'替换文本'栏输入内容，点击[全局替换]后即可完成内容替换
  - 导航选择文件夹，右键选择[在文件夹中搜索]，即可仅在当前路径下搜索
  
  ![内容搜索替换](/images/user-guide/内容搜索替换.gif)
  ![指定路径搜索](/images/user-guide/指定路径搜索.gif)

### 8.2 文件搜索
  - 通过快捷键[ctrl + p]打开文件搜索，输入文件名后按下[enter]键开始搜索
  - 文件名后图标代表了该文件支持的多种打开方式
