...
![创建工程](/images/user-guide/浏览文件夹.png)
4. 点击[完成]后,工程创建成功,在左侧导航栏区域即可查看到当前创建的工程


### 1.2 切换工程
1. 顶部菜单栏选择 [工程] - [切换工程] 显示了当前工作空间可供切换的全部工程，点击某个工程即可切换
...
3.  启动工程时，AgreeStudio 能简单提示工程是否启动，以及失败原因以及错误码。
    ![启动工程](/images/user-guide/启动工程1.jpg)
### 1.4 导入工程
1.  顶部菜单栏选择 [工程] - [导入工程] 会弹出导入工程文件的弹窗。![导入工程](/images/user-guide/导入工程.png)
2.  选择要导入的工程文件，点击确定，工程导入成功，会在左侧导航栏查看到导入的新工程文件；
